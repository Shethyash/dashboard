                        ...
                        <tbody class="customtable">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn margin-5 text-white btn-del" onclick="openDelete('post','user_id','{{$value->id}}')" data-toggle="modal" data-target="#DeleteModel" data-placement="top" title="Delete"><i class="fas fa-trash-alt"></i></button>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                    {{ $post->appends(\Request::except('page'))->render('layout.pagination') }}
                </div>
            </div>
        </div>
    </div>
